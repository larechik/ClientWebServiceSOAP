 ...
 * generated in the com.makhnovetc.ifmo.soap.lab2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdatePerson_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "updatePerson");
    private final static QName _InsertPerson_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "insertPerson");
    ...
    private final static QName _DeletePerson_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "deletePerson");
    private final static QName _GetPersonsQuery_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "getPersonsQuery");
    private final static QName _InsertPersonResponse_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "insertPersonResponse");
    private final static QName _UpdatePersonResponse_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "updatePersonResponse");
    private final static QName _DeletePersonResponse_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "deletePersonResponse");
    private final static QName _FindPeople_QNAME = new QName("http://lab1.soap.ifmo.makhnovetc.com/", "findPeople");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.makhnovetc.ifmo.soap.lab2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "updatePerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "insertPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "deletePerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "insertPersonResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "updatePersonResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lab1.soap.ifmo.makhnovetc.com/", name = "deletePersonResponse")
